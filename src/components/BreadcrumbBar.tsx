...
export function BreadcrumbBar() {
  ...
  const routeMap: Record<string, { menu: string; submenu: string }> = {
    ...
    "variantes-productos": { menu: "Stock", submenu: "Variantes de productos" },
    "talles-colores": { menu: "Stock", submenu: "Talles y colores" },
    "ventas": { menu: "Ventas", submenu: "Ventas" },
    "pagos": { menu: "Ventas", submenu: "Pagos" },
    "caja": { menu: "Tesorería", submenu: "Cajas" },
    "gastos-empleados": { menu: "Tesorería", submenu: "Gastos de mi Comercio" },
    "cuentas-corrientes": { menu: "Ventas", submenu: "Cuentas Corrientes" },
    "informes": { menu: "Informes", submenu: "Informes" },
    "stock-faltante": { menu: "Informes", submenu: "Stock Faltante" },
    "importacion-stock": { menu: "Importaciones de datos", submenu: "Importar Stock" },
